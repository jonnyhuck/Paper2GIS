...
/* WE ARE ZOOM LEVEL 15 */
/* @rdz15_maj: 6;   @rdz15_med: 4;   @rdz15_min: 2; */
@rdz15_maj: 7;   @rdz15_med: 5;   @rdz15_min: 4;
...
#bridge[render='1_outline'][zoom>=11][zoom<=20]{
  ...
  [zoom=15] {
    ...
    [stylegroup='noauto']   { line-width: @rdz15_min / 2 + 2; }
...
#bridge[render='3_inline'][zoom>=11][zoom<=20]{
  ...
  [zoom=15] {
    ...
    [stylegroup='service']  { line-width: @rdz15_min / 2; }                       /* /3 */
    [stylegroup='noauto']   { line-width: @rdz15_min / 2; line-dasharray: 1,1; }  /* /4 */
